...
movie_posters_bucket_name        = "BUCKET_NAME-cinevision-dev-movie-posters"
email_archives_bucket_name       = "BUCKET_NAME-cinevision-dev-email-archives"
frontend_aliases                 = ["dev.DOMAIN_NAME"]
acm_certificate_arn              = "arn:aws:acm:us-east-1:211026994790:certificate/DEV_CERTIFICATE_ID"
rds_instance_class               = "db.t4g.medium"
db_name                          = "cinevision"
db_username                      = "cinevision_admin"
docdb_master_username            = "cinevision_docdb_admin"
database_credentials_secret_name = "/cinevision/dev/database-credentials"
application_secrets_secret_name  = "/cinevision/dev/application-secrets"
